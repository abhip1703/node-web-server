...
echo "<script>alert('Product aaded to wishlist');</script>";
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">
			<div class="image">
				<img src="assets/images/banners/Annotation.png" alt="" class="img-responsive">
			</div>
...
{?>
	...
	<div class="product">
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>No Products Found</h3>
		</div>
