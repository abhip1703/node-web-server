...
<center><button  name="continue" class="btn-upper btn btn-primary checkout-page-button"><a href="index.php" style="color: inherit;">Continue shopping</a></button>    <button  name="continue" class="btn-upper btn btn-primary checkout-page-button"><a href="my-cart.php" style="color: inherit;">Go to Cart</a></button></center>
